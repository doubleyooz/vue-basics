  ...
  <div id="PostMain" class="flex border-b py-6">
    ...
    <div class="pl-3 w-full px-4">
      <div class="flex items-center justify-between pb-0.5">
        ...
        <button
          class="border text-[15px] px-[21px] py-0.5 border-[#F02C56] text-[#F02C56] font-semibold rounded-md hover:bg-[#FFEEF2]"
        >
          Follow
        </button>
      </div>
      ...
      <div class="text-sm text-gray-500 pb-0.5">#fun #cool #NegativeCreep</div>
      <div class="text-sm pb-0.5 flex items-center font-semibold">
                ...
                <div class="relative mr-[75px]">
                    <div class="absolute bottom-0 pl-2">
                        <div class="pb-4 text-center">
                            ...
                            <span class="text-xs text-gray-800 font-semibold">14</span>
                        </div>
                        <div class="pb-4 text-center">
                            <button class="rounded-full bg-gray-200 p-2 cursor-pointer">
                        ...
                        <div class="pb-4 text-center">
                            ...
                            <span class="text-xs text-gray-800 font-semibold">8</span>
                        </div>
                    </div>
                </div>
