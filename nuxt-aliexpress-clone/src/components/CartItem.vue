<template>
    <div class="flex justify-start my-2">
        <div class="my-auto">
            <div class="flex items-center justify-start p-0.5 cursor-pointer" @mouseenter="isHover = true"
        ...
        <div class="overflow-hidden pl-2 w-full">
            <div class="flex items-center justify-between w-full">
                <div class="flex items-center justify-between truncate">
                    <span
                        class="sm:block hidden bg-[#FD374F] text-white text-[9px] front-semibold px-1.5 rounded-sm min-w-[80px]">Welcome
                        Deal</span>
            ...
            <div class="flex items-center justify-end">
                <button @click="removeFromCart()" class="sm:hidden -mt-0.5 hover:text-red-500">
                    <Icon name="material-symbols:delete-outline" size="20" />
                </button>
            </div>
        </div>
...
watch(() => isSelected.value, (value => {
    emit('selectedRadio', { id: product.value.id, val: value })
}))
</script>
