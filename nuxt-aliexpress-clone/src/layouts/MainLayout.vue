<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
      ...
      >
        <li
          class="border-r px-3 border-r-gray-400 hover:text-[#FF4646] cursor-pointer"
        >
          Sell on AliExpress
        </li>
        <li
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div
        class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5"
      >
        <NuxtLink to="/" class="min-w-[170px]">
          <img src="~assets/AliExpress-logo.png" width="170" alt="logo" />
        </NuxtLink>

        <div class="max-w-[700px] w-full md:flex hidden">
          <div class="relative">
            <div
        ...
        <button
          @click="userStroe.isMenuOverlay = true"
